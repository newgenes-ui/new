  ...
  return (
    <div className="pt-32 pb-20 px-8 max-w-7xl mx-auto">
      ...
      >
        ...
        <a 
          href="http://www.jenixbio.com/jenix/main" 
          target="_blank" 
      ...
      >
        <h3 className="text-4xl md:text-5xl font-bold font-headline text-primary mb-8 tracking-wide">Deinoxanthin</h3>
        <div className="w-full max-w-5xl rounded-3xl overflow-hidden shadow-2xl border border-surface-container-highest bg-white p-4">
          <img 
            src="/deinoxanthin.png" 
            alt="Deinoxanthin" 
